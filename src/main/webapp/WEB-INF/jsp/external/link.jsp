...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Argendata - Url externa</title>
	...
	<div id="bar" style="height:90px; border-bottom: 3px solid snow; background:#ccc url(../../images/stripe-frame.png) repeat-x;">
		...
		<div class="span-12" style="padding-top:6px; text-align:right" >
			...
			<a target="new" href="mailto:?subject=Informacion encontrada en argendata&body=Mira lo que encontre en argendata: <c:out value="${socialUrl}" />"><img border="0"  style="padding-top: 4px" height="32px" title="email"  alt="email" src="../../images/email.png"/></a>
			<span>&nbsp;&nbsp;</span>
			<a target="new" href="http://twitter.com/intent/tweet?url=<c:out value="${socialUrl}"/>&text=Mira el dataset que descubrí en argendata:&via=argendata">
			<img border="0"  style="padding-top: 4px" height="32px" title="twitter"  alt="twitter" src="../../images/twitter-2.png"/></a>
			<span>&nbsp;&nbsp;</span>
			<a target="new" href="http://www.facebook.com/sharer.php?u=<c:out value="${socialUrl}"/>&t=Lo%20que%20descubri%20en%20argendata"><img border="0" style="padding-top: 4px" height="32px" title="facebook"  alt="facebook" src="../../images/facebook.png"/></a>
		</div>
