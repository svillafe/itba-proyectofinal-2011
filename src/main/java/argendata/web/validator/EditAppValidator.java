...
@Component
public class EditAppValidator implements Validator {

	private AppService appService;
	
	@Autowired
	public EditAppValidator(AppService appService){
	...
	public void validate(Object target, Errors errors) {
		...
		if(appForm.getUrl()!=null && appForm.getUrl().length() > 600){
			errors.rejectValue("url", "AppForm.invalid.url","La dirección es muy larga.");
		}
